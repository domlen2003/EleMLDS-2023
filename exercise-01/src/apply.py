...
# load datasets
data = [[], [], []]
data[0] = np.loadtxt("data/data/data1")
data[1] = np.loadtxt("data/data/data2")
data[2] = np.loadtxt("data/data/data3")
...
# load gamma values
testgamma = [[], [], []]
testgamma[0] = np.loadtxt("data/gamma/gamma1")
testgamma[1] = np.loadtxt("data/gamma/gamma2")
testgamma[2] = np.loadtxt("data/gamma/gamma3")
for idx in range(3):
